...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = tkinter.Button(height=100, width=97, image=true_image, highlightthickness=0,
                                          command=self.true_pressed)
        self.true_button.grid(row=2, column=0)
        false_image = tkinter.PhotoImage(file="images/false.png")
        self.false_button = tkinter.Button(height=100, width=97, image=false_image, highlightthickness=0,
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text,
                                   text=f"You have reached the end of the quiz and your final score is {self.quiz.score}")
